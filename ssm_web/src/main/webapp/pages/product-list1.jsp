                    ...
                    <div class="table-box">
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-default" title="删除" id="deleteProduct"><i class="fa fa-trash-o"></i> 删除</button>
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="text-center sorting_desc">编号</th>
                            ...
                            <c:forEach items="${productList}" var="product">
                                <tr>
                                    <td><input name="ids" type="checkbox" id="${product.id}"></td>
    ...
    $("#deleteProduct").click(function () {
        if(window.confirm("您确定要删除吗？")){
            ...
            if(str == ""){
                ...
                alert("删除成功");
                location.href = "${pageContext.request.contextPath}/product/delete?productIds="+str;
            }
        }
    })
